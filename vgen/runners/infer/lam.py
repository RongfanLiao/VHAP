...
from vgen.datasets.cam_utils import build_camera_principle, build_camera_standard, surrounding_views_linspace, create_intrinsics
from vgen.utils.logging import configure_logger
from vgen.runners import REGISTRY_RUNNERS
from vgen.utils.video import images_to_video
from vgen.utils.hf_hub import wrap_model_hub
from vgen.models.modeling_lam import ModelLAM
from safetensors.torch import load_file
import moviepy.editor as mpy
# FlameTrackingSingleImage removed (tools/ not included in VHAP integration)
...
class LAMInferrer(Inferrer):
    ...
    def _build_model(self, cfg):
        """
        from vgen.models import model_dict
