...
from vgen.datasets.base import BaseDataset
from vgen.datasets.cam_utils import build_camera_standard, build_camera_principle, camera_normalization_objaverse
from vgen.utils.proxy import no_proxy
...
if __name__ == "__main__":
    ...
    for idx, data in enumerate(dataset):
        ...
        for i in range(ret["animated"].shape[0]):
            ...
            intr = data["intrs"][i]
            from vgen.models.rendering.utils.vis_utils import render_mesh
