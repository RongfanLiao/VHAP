...
from vgen.models.rendering.flame_model.flame import FlameHeadSubdivided
from vgen.models.transformer import TransformerDecoder
from pytorch3d.transforms import matrix_to_quaternion
from vgen.models.rendering.utils.typing import *
from vgen.models.rendering.utils.utils import trunc_exp, MLP
...
import vgen.models.rendering.utils.mesh_utils as mesh_utils
from vgen.models.rendering.utils.point_utils import depth_to_normal
    ...
    def __init__(
        ...
        if decode_with_extra_info is not None:
            if decode_with_extra_info["type"] == "dinov2p14_feat":
                ...
                from vgen.models.encoders.dinov2_wrapper import Dinov2Wrapper
                ...
                from vgen.models.encoders.xunet_wrapper import XnetWrapper
...
def test_head():
    ...
    from vgen.datasets.video_head import VideoHeadDataset
